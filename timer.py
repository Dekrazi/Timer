...
btn_five = tk.Button(
    master=window, text="5 minutes", command=lambda: add_minutes(5), width=12
)
btn_five.grid(row=3, column=6, pady=10)

btn_ten = tk.Button(
    master=window, text="10 minutes", command=lambda: add_minutes(10), width=12
)
btn_ten.grid(row=3, column=7, pady=10)

btn_fifteen = tk.Button(
